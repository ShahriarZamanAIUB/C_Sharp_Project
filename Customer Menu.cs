...
namespace WindowsFormsApp5
{
    ...
    public partial class Form6 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (dr.HasRows == false)
            { DialogResult d = MessageBox.Show("Manager is yet to set conditions", "Not Now", MessageBoxButtons.OK, MessageBoxIcon.Information); con.Close(); cmd.Dispose(); }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            string qryHH = "select * from logintable where usertype='Customer' and id=(select id from loggedinuserinfo);";
